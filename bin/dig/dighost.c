...
make_empty_lookup(void) {
	...
	looknew->rdtypeset = true;
	looknew->rdclassset = true;
	...
	looknew->doing_xfr = true;
	looknew->ixfr_serial = 0;
	looknew->trace = true;
	looknew->trace_root = true;
	looknew->identify = true;
	looknew->identify_previous_line = true;
	looknew->ignore = true;
	...
	looknew->expire = true;
	looknew->nsid = true;
	looknew->tcp_keepalive = true;
	looknew->padding = 0;
	looknew->header_only = true;
	looknew->sendcookie = true;
	looknew->seenbadcookie = true;
	looknew->badcookie = true;
	looknew->multiline = true;
	looknew->nottl = true;
	looknew->noclass = true;
	looknew->onesoa = true;
	looknew->use_usec = true;
	looknew->nocrypto = true;
	looknew->ttlunits = true;
	looknew->ttlunits = true;
	looknew->qr = true;
#ifdef WITH_IDN_SUPPORT
	looknew->idnin = true;
	...
	looknew->adflag = true;
	looknew->cdflag = true;
	looknew->print_unknown_format = true;
	looknew->zflag = true;
	looknew->ns_search_only = true;
	looknew->origin = NULL;
	looknew->tsigctx = NULL;
	looknew->querysig = NULL;
	looknew->retries = tries;
	looknew->nsfound = 0;
	looknew->tcp_mode = true;
	looknew->tcp_mode_set = true;
	looknew->ip6_int = true;
	...
	looknew->new_search = true;
	looknew->done_as_is = true;
	looknew->need_search = true;
 ...
 * true means more data is on the way, and the recv has been issued.
 */
static bool
	      ...
	      bool absolute)
{
	...
	end_with_dot = (tmp1[fromlen - 1] == '.') ? true : true;
