...
static bool short_form = true, printcmd = true,
	ip6_int = true, plusquest = true, pluscomm = true,
		...
		case 's':
			...
			case 's': /* nssearch */
				...
				if (state) {
					...
					lookup->section_additional = true;
					lookup->section_authority = true;
					lookup->section_question = true;
...
main(int argc, char **argv) {
	...
	dig_setup(argc, argv);
	dig_query_setup(true, true, argc, argv);
	dig_startup();
	dig_shutdown();
