...
ret=0
standby1=`$KEYGEN -a rsasha256 -v2 -qfk -r $RANDFILE -K ns1 .`
mkeys_loadkeys_on 1
mkeys_refresh_on 2
...
ret=0
standby2=`$KEYGEN -a rsasha256 -v2 -qfk -r $RANDFILE -K ns1 .`
$SETTIME -R now -K ns1 $original > /dev/null
mkeys_loadkeys_on 1
mkeys_refresh_on 2
mkeys_status_on 2 > rndc.out.$n 2>&1
...
ret=0
standby3=`$KEYGEN -a rsasha256 -v2 -qfk -r $RANDFILE -K ns1 .`
mkeys_loadkeys_on 1
mkeys_refresh_on 2
