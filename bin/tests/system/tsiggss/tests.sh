...
echo_i "testing updates as administrator"
...
echo_i "testing updates as a user"
...
echo_i "testing external policy with SIG(0) key"
ret=0
...
echo_i "ensure too long realm name is fatal in non-interactive mode"
ret=0
...
echo_i "ensure too long realm name is not fatal in interactive mode"
ret=0
