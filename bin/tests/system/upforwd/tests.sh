...
ret=0
{ $PERL ../digcomp.pl knowngood.before dig.out.ns1 || ret=1; } | cat_i
{ $PERL ../digcomp.pl knowngood.before dig.out.ns2 || ret=1; } | cat_i
{ $PERL ../digcomp.pl knowngood.before dig.out.ns3 || ret=1; } | cat_i
if [ $ret != 0 ] ; then echo_i "failed"; status=`expr $status + $ret`; fi
...
ret=0
{ $PERL ../digcomp.pl knowngood.after1 dig.out.ns1 || ret=1; } | cat_i
{ $PERL ../digcomp.pl knowngood.after1 dig.out.ns2 || ret=1; } | cat_i
{ $PERL ../digcomp.pl knowngood.after1 dig.out.ns3 || ret=1; } | cat_i
if [ $ret != 0 ] ; then echo_i "failed"; status=`expr $status + $ret`; fi
...
echo_i "comparing post-update copies to known good data ($n)"
ret=0
{ $PERL ../digcomp.pl knowngood.after2 dig.out.ns1 || ret=1; } | cat_i
{ $PERL ../digcomp.pl knowngood.after2 dig.out.ns2 || ret=1; } | cat_i
{ $PERL ../digcomp.pl knowngood.after2 dig.out.ns3 || ret=1; } | cat_i
if [ $ret != 0 ] ; then echo_i "failed"; status=`expr $status + $ret`; fi
n=`expr $n + 1`
