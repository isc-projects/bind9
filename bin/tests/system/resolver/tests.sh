...
if [ -x ${RESOLVE} ] ; then
   ...
   ret=0
   ${RESOLVE} $RESOLVOPTS -b 10.53.0.8 -t a -s 10.53.0.1 www.example.org 2> resolve.out.ns1.test${n} || ret=1
...
ret=0
$DIG $DIGOPTS soa all-cnames @10.53.0.5 +opcode=15 +cd +rec +ad > dig.out.ns5.test${n} || ret=1
...
ret=0
$DIG $DIGOPTS +qr soa . @10.53.0.5 +subnet=255.255.255.255/23 > dig.out.ns5.test${n} || ret=1
