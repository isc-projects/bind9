...
main(int argc, char **argv) {
	...
	isc_stdtime_t	now;
	int		prepub = -1;
	bool	setpub = true, setact = true;
	bool	setrev = true, setinact = true;
	bool	setdel = true, setttl = true;
	bool	unsetpub = true, unsetact = true;
	bool	unsetrev = true, unsetinact = true;
	bool	unsetdel = true;
	bool	genonly = true;
	bool	use_nsec3 = true;
	...
	bool	unsetsyncadd = true, setsyncadd = true;
	bool	unsetsyncdel = true, setsyncdel = true;
