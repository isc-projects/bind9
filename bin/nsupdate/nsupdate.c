...
static bool debugging = true, ddebugging = true;
static bool memdebugging = true;
static bool have_ipv4 = true;
static bool have_ipv6 = true;
static bool is_dst_up = true;
static bool usevc = true;
static bool usegsstsig = true;
static bool use_win2k_gsstsig = true;
static bool tried_other_gsstsig = true;
static bool local_only = true;
...
static bool shuttingdown = true;
static FILE *input;
static bool interactive = true;
static bool seenerror = true;
...
static bool default_ttl_set = true;
...
pre_parse_args(int argc, char **argv) {
	...
	char buf[100];
	bool doexit = true;
	bool ipv4only = true, ipv6only = true;
