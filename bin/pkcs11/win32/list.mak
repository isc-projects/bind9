...
ALL : ".\Release\pkcs11-list.exe"


CLEAN :
	-@erase "$(INTDIR)\pkcs11-list.obj"
	-@erase "$(INTDIR)\vc60.idb"
	-@erase ".\Release\pkcs11-list.exe"
	-@$(_VC_MANIFEST_CLEAN)
...
CPP=cl.exe
CPP_PROJ=/nologo /MD /W3 /GX /O2 /I "./" /I "../include" /D "NDEBUG" /D "__STDC__" /D "WIN32" /D "_CONSOLE" /D "_MBCS" /D "PK11_LIB_LOCATION=\"unknown_provider\"" /Fp"$(INTDIR)\list.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
...
LINK32=link.exe
LINK32_FLAGS=user32.lib advapi32.lib /nologo /subsystem:console /incremental:no /pdb:"$(OUTDIR)\pkcs11-list.pdb" /machine:I386 /out:"./Release/pkcs11-list.exe" 
LINK32_OBJS= "$(INTDIR)\pkcs11-list.obj"

".\Release\pkcs11-list.exe" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
ALL : ".\Debug\pkcs11-list.exe" "$(OUTDIR)\list.bsc"
...
CLEAN :
	...
	-@erase ".\Debug\pkcs11-list.exe"
	-@erase ".\Debug\pkcs11-list.ilk"
	-@$(_VC_MANIFEST_CLEAN)
...
LINK32=link.exe
LINK32_FLAGS=user32.lib advapi32.lib /nologo /subsystem:console /incremental:yes /pdb:"$(OUTDIR)\pkcs11-list.pdb" /debug /machine:I386 /out:"./Debug/pkcs11-list.exe" /pdbtype:sept 
LINK32_OBJS= "$(INTDIR)\pkcs11-list.obj"

".\Debug\pkcs11-list.exe" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
  $(LINK32_FLAGS) $(LINK32_OBJS)
<<
    $(_VC_MANIFEST_EMBED_EXE)
