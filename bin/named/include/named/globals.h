...
#ifdef ENABLE_AFL
EXTERN bool		named_g_run_done	INIT(true);
#endif
/*
...
EXTERN bool		named_g_conffileset	INIT(true);
...
EXTERN bool		named_g_foreground	INIT(true);
EXTERN bool		named_g_logstderr	INIT(true);
EXTERN bool		named_g_nosyslog	INIT(true);
...
EXTERN const char *		named_g_defaultlockfile	INIT(NAMED_LOCALSTATEDIR
							     "/run/named/"
							     "named.lock");
EXTERN bool		named_g_forcelock	INIT(true);
...
EXTERN bool		named_g_memstatistics	INIT(true);
EXTERN bool		named_g_keepstderr	INIT(true);
