...
NOTES ON BIND 9.8 FOR WINDOWS:

BIND 9.8 is known to run on Windows XP, Vista, Windows 7,
...
dnssec-keygen, dnssec-signzone, dnssec-dsfromkey, dnssec-keyfromlabel,
dnssec-revoke, dnssec-settime. The latter tools are for use with DNSSEC.
All tools are installed in the "%ProgramFiles%\ISC BIND 9\bin" directory.
