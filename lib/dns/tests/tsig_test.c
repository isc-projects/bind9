...
ATF_TC_BODY(algvalid, tc) {
	...
	ATF_REQUIRE_EQ(dns__tsig_algvalid(DST_ALG_GSSAPI), true);
}
...
ATF_TC_BODY(algallocated, tc) {
	...
	/* test the standard algorithms */
#ifndef PK11_MD5_DISABLE
	ATF_REQUIRE_EQ(dns__tsig_algallocated(DNS_TSIG_HMACMD5_NAME), true);
#endif

	ATF_REQUIRE_EQ(dns__tsig_algallocated(DNS_TSIG_HMACSHA1_NAME), true);
	ATF_REQUIRE_EQ(dns__tsig_algallocated(DNS_TSIG_HMACSHA224_NAME), true);
	ATF_REQUIRE_EQ(dns__tsig_algallocated(DNS_TSIG_HMACSHA256_NAME), true);
	ATF_REQUIRE_EQ(dns__tsig_algallocated(DNS_TSIG_HMACSHA384_NAME), true);
	ATF_REQUIRE_EQ(dns__tsig_algallocated(DNS_TSIG_HMACSHA512_NAME), true);
