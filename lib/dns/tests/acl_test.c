...
ATF_TC_BODY(dns_acl_isinsecure, tc) {
	...
	result = dns_acl_merge(notnone, none, true);
	ATF_REQUIRE_EQ(result, ISC_R_SUCCESS);

	result = dns_acl_merge(notany, any, true);
	ATF_REQUIRE_EQ(result, ISC_R_SUCCESS);
	...
	result = dns_acl_merge(notgeoip, geoip, true);
#endif
	...
	for (pass = 0; pass < sizeof(ecs)/sizeof(ecs[0]); pass++) {
		...
		result = dns_acl_merge(notpos4pos6, pos4pos6, true);
		ATF_REQUIRE_EQ(result, ISC_R_SUCCESS);
		...
		result = dns_acl_merge(notneg4pos6, neg4pos6, true);
		ATF_REQUIRE_EQ(result, ISC_R_SUCCESS);
		...
		result = dns_acl_merge(notpos4neg6, pos4neg6, true);
		ATF_REQUIRE_EQ(result, ISC_R_SUCCESS);
		...
		result = dns_acl_merge(notneg4neg6, neg4neg6, true);
		ATF_REQUIRE_EQ(result, ISC_R_SUCCESS);
		...
		result = dns_acl_merge(notloop4, loop4, true);
		ATF_REQUIRE_EQ(result, ISC_R_SUCCESS);
		...
		result = dns_acl_merge(notloop6, loop6, true);
		ATF_REQUIRE_EQ(result, ISC_R_SUCCESS);
		...
		result = dns_acl_merge(notloop4pos6, loop4pos6, true);
		ATF_REQUIRE_EQ(result, ISC_R_SUCCESS);
		...
		result = dns_acl_merge(notloop4neg6, loop4neg6, true);
		ATF_REQUIRE_EQ(result, ISC_R_SUCCESS);
