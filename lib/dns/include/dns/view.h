 ...
 * is a backward compatible version equivalent to setcache2(..., true).
 *
 * Requires:
 *
 *\li	'view' is a valid, unfrozen view.
 ...
 * unless 'use_static_stub' is true (see below about this argument).
 *
 * dns_view_find() is a backward compatible version equivalent to
 * dns_view_find2() with use_static_stub argument being true.
 *
 * Notes:
 *
 ...
 *	#DNS_R_HINTNXRRSET.
 *
 *\li	If 'use_static_stub' is true and the longest match zone for 'name'
 ...
 *	true.  The only known usage of this argument being true is
 ...
 * If 'stop' is true (or we are loading asynchronously), ignore errors.
 *
 * Requires:
 *
 *\li	'view' is valid.
 ...
 * Equivalent to dns_view_flushnode(view, name, true).
 *
 *
 * Requires:
 *\li	'view' is valid.
 ...
 *
 * If 'checknta' is true, ignore the NTA table in determining
 ...
 *
 * If 'allow' is true, removes any existing references to
