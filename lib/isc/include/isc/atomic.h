...
#elif !HAVE_STDATOMIC /* the default on GCC, and Clang */
...
#define atomic_compare_exchange_strong(obj, expected, desired)		\
	__atomic_compare_exchange_n(obj, expected, desired, __ATOMIC_SEQ_CST, __ATOMIC_SEQ_CST)

#define atomic_compare_exchange_strong_explicit(obj, expected, desired, succ, fail) \
	__atomic_compare_exchange_n(obj, expected, desired, succ, fail)
...
#elif !HAVE_STDATOMIC && !HAVE___ATOMIC
...
#else /* !HAVE_STDATOMIC && !HAVE___ATOMIC */

#error Impossible situation, fix your toolchain
...
#if defined(_WIN32) || (!HAVE_STDATOMIC || !HAVE___ATOMIC)
