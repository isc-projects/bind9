...
isc_result_t isc_buffer_allocate(isc_mem_t *mctx, isc_buffer_t **dynbuffer,
                                 unsigned int length);
/*!<
...
void isc_buffer_setautorealloc(isc_buffer_t *b, isc_boolean_t enable);
/*!<
...
void isc__buffer_usedregion(const isc_buffer_t *b, isc_region_t *r);
/*!<
...
void isc__buffer_putmem(isc_buffer_t *b, const unsigned char *base,
                        unsigned int length);
/*!<
...
void isc_buffer_putdecint(isc_buffer_t *b, isc_int64_t v);
/*!<
...
isc_result_t isc_buffer_dup(isc_mem_t *mctx, isc_buffer_t **dstp,
                            const isc_buffer_t *src);
/*!<
...
isc_result_t isc_buffer_printf(isc_buffer_t *b, const char *format, ...)
