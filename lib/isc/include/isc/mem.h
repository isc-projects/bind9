...
isc_result_t
isc_mempool_create(isc_mem_t *mctx, size_t size, isc_mempool_t **mpctxp _ISC_MEM_FLARG);
/*%<
...
void
isc_mempool_destroy(isc_mempool_t **mpctxp _ISC_MEM_FLARG);
/*%<
 ...
 */
void *
isc_mem_get(isc_mem_t *mctx, size_t size _ISC_MEM_FLARG);
void
isc_mem_putanddetach(isc_mem_t **ctxp, void *ptr, size_t size _ISC_MEM_FLARG);
void
isc_mem_put(isc_mem_t *mctx, void *ptr, size_t size _ISC_MEM_FLARG);
void *
isc_mem_allocate(isc_mem_t *mctx, size_t size _ISC_MEM_FLARG);
void *
isc_mem_reallocate(isc_mem_t *mctx, void *ptr, size_t size _ISC_MEM_FLARG);
void
isc_mem_free(isc_mem_t *mctx, void *ptr _ISC_MEM_FLARG);
char *
isc_mem_strdup(isc_mem_t *mctx, const char *s _ISC_MEM_FLARG);
void *
isc_mempool_get(isc_mempool_t *mpctx _ISC_MEM_FLARG);
void
isc_mempool_put(isc_mempool_t *mpctx, void *mem _ISC_MEM_FLARG);
