...
#define RECVCMSGBUFLEN (2*(CMSG_SP_IN6PKT + CMSG_SP_TIMESTAMP + CMSG_SP_TCTOS))
#define SENDCMSGBUFLEN (2*(CMSG_SP_IN6PKT + CMSG_SP_INT + CMSG_SP_TCTOS))
...
#if defined(ISC_PLATFORM_HAVEIPV6)
		if (sock->pf == AF_INET6 && RECVCMSGBUFLEN == 0) {
			/*
