...
void isc_interval_set(isc_interval_t *i, unsigned int seconds,
                      unsigned int nanoseconds);
/*%<
...
void isc_time_set(isc_time_t *t, unsigned int seconds,
                  unsigned int nanoseconds);
/*%<
...
isc_result_t isc_time_add(const isc_time_t *t, const isc_interval_t *i,
                          isc_time_t *result);
/*%<
...
isc_result_t isc_time_subtract(const isc_time_t *t, const isc_interval_t *i,
                               isc_time_t *result);
/*%<
...
void isc_time_formathttptimestamp(const isc_time_t *t, char *buf,
                                  unsigned int len);
/*%<
 * Format the time 't' into the buffer 'buf' of length 'len',
...
isc_result_t isc_time_parsehttptimestamp(char *input, isc_time_t *t);
/*%<
...
void isc_time_formatISO8601L(const isc_time_t *t, char *buf, unsigned int len);
/*%<
 * Format the time 't' into the buffer 'buf' of length 'len',
...
void isc_time_formatISO8601Lms(const isc_time_t *t, char *buf,
                               unsigned int len);
/*%<
 * Format the time 't' into the buffer 'buf' of length 'len',
...
void isc_time_formatISO8601ms(const isc_time_t *t, char *buf, unsigned int len);
/*%<
 * Format the time 't' into the buffer 'buf' of length 'len',
...
void isc_time_formatshorttimestamp(const isc_time_t *t, char *buf,
                                   unsigned int len);
/*%<
 * Format the time 't' into the buffer 'buf' of length 'len',
