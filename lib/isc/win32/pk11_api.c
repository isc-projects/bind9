                        ...
                        CK_MECHANISM_INFO_PTR pInfo)
{
	...
	if (hPK11 == NULL)
		return (CKR_LIBRARY_FAILED_TO_LOAD);
	if (sym == NULL)
		sym = (CK_C_GetMechanismInfo)GetProcAddress(
		        hPK11, "C_GetMechanismInfo");
	if (sym == NULL)
		return (CKR_SYMBOL_RESOLUTION_FAILED);
                         ...
                         CK_ATTRIBUTE_PTR pTemplate, CK_ULONG usCount)
{
	...
	if (hPK11 == NULL)
		return (CKR_LIBRARY_FAILED_TO_LOAD);
	if (sym == NULL)
		sym = (CK_C_GetAttributeValue)GetProcAddress(
		        hPK11, "C_GetAttributeValue");
	if (sym == NULL)
		return (CKR_SYMBOL_RESOLUTION_FAILED);
                         ...
                         CK_ATTRIBUTE_PTR pTemplate, CK_ULONG usCount)
{
	...
	if (hPK11 == NULL)
		return (CKR_LIBRARY_FAILED_TO_LOAD);
	if (sym == NULL)
		sym = (CK_C_SetAttributeValue)GetProcAddress(
		        hPK11, "C_SetAttributeValue");
	if (sym == NULL)
		return (CKR_SYMBOL_RESOLUTION_FAILED);
	return (*sym)(hSession, hObject, pTemplate, usCount);
}
...
pkcs_C_FindObjectsFinal(CK_SESSION_HANDLE hSession)
{
	...
	if (hPK11 == NULL)
		return (CKR_LIBRARY_FAILED_TO_LOAD);
	if (sym == NULL)
		sym = (CK_C_FindObjectsFinal)GetProcAddress(
		        hPK11, "C_FindObjectsFinal");
	if (sym == NULL)
		return (CKR_SYMBOL_RESOLUTION_FAILED);
	return (*sym)(hSession);
}
