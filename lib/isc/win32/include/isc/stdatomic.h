...
#define atomic_store_explicit(obj, desired, order) 			\
	switch (sizeof(*obj)) {						\
	case 32: atomic_store_explicit32(obj, desired, order); break;	\
	case 64: atomic_store_explicit64(obj, desired, order); break;	\
	default: INSIST(0);						\
	}
...
static inline bool
atomic_compare_exchange_strong32(atomic_fast_int32_t *obj, int32_t *expected, int32_t desired, memory_order succ, memory_order fail) {
	bool __r;
	intptr_t __v;
	REQUIRE(succ == fail);
	switch (succ) {
...
static inline bool
atomic_compare_exchange_strong64(atomic_fast_int64_t *obj, int64_t *expected, int64_t desired, memory_order succ, memory_order fail) {
	bool __r;
	intptr_t __v;
	REQUIRE(succ == fail);
	switch (succ) {
