...
static void
isc_md_test(isc_md_t *md, isc_md_type_t type, const char *buf, size_t buflen, const char *result, const int repeats) {
	assert_non_null(md);
	...
	for (i = 0; i < repeats; i++) {
		assert_int_equal(isc_md_update(md, (const unsigned char *)buf, buflen), ISC_R_SUCCESS);
	}
	...
	assert_return_code(tohexstr((const unsigned char *)digest, (const unsigned int)digestlen, hexdigest, sizeof(hexdigest)), 0);
...
isc_md_md5_test(void **state) {
	...
	isc_md_test(md, ISC_MD_MD5, TEST_INPUT(""), "0xD41D8CD98F00B204E9800998ECF8427E", 1);
	isc_md_test(md, ISC_MD_MD5, TEST_INPUT("a"), "0x0CC175B9C0F1B6A831C399E269772661", 1);
	isc_md_test(md, ISC_MD_MD5, TEST_INPUT("abc"), "0x900150983CD24FB0D6963F7D28E17F72", 1);
	isc_md_test(md, ISC_MD_MD5, TEST_INPUT("message digest"), "0xF96B697D7CB7938D525A2F31AAF161D0", 1);
	isc_md_test(md, ISC_MD_MD5, TEST_INPUT("abcdefghijklmnopqrstuvwxyz"),
		    "0xC3FCD3D76192E4007DFB496CCA67E13B", 1);
	isc_md_test(md, ISC_MD_MD5, TEST_INPUT("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklm"
					   "nopqrstuvwxyz0123456789"), "0xD174AB98D277D9F5A5611C2C9F419D9F", 1);
	isc_md_test(md, ISC_MD_MD5, TEST_INPUT("123456789012345678901234567890123456789"
...
isc_md_sha1_test(void **state) {
	...
	isc_md_test(md, ISC_MD_SHA1, TEST_INPUT("abcdbcdecdefdefgefghfghighijhijkijk"
	...
	isc_md_test(md, ISC_MD_SHA1, TEST_INPUT("a"),
		    ...
		    1000000);
	isc_md_test(md, ISC_MD_SHA1, TEST_INPUT("01234567012345670123456701234567"),
	...
	isc_md_test(md, ISC_MD_SHA1, TEST_INPUT("\x5e"),
		    ...
		    1);
	isc_md_test(md, ISC_MD_SHA1, TEST_INPUT("\x9a\x7d\xfd\xf1\xec\xea\xd0\x6e\xd6\x46"
					    "\xaa\x55\xfe\x75\x71\x46"),
		    "0x82ABFF6605DBE1C17DEF12A394FA22A82B544A35",
		    1);
	isc_md_test(md, ISC_MD_SHA1, TEST_INPUT("\xf7\x8f\x92\x14\x1b\xcd\x17\x0a\xe8\x9b"
...
isc_md_sha224_test(void **state) {
	...
	isc_md_test(md, ISC_MD_SHA224, TEST_INPUT("abc"),
		    ...
		    "E36C9DA7",
		    1);
	isc_md_test(md, ISC_MD_SHA224, TEST_INPUT("abcdbcdecdefdefgefghfghighijhijkijklj"
					       "klmklmnlmnomnopnopq"),
	...
	isc_md_test(md, ISC_MD_SHA224, TEST_INPUT("a"),
		    ...
		    "EE4EE7AD67",
		    1000000);
	isc_md_test(md, ISC_MD_SHA224, TEST_INPUT("01234567012345670123456701234567"),
	...
	isc_md_test(md, ISC_MD_SHA224, TEST_INPUT("\x07"),
		    ...
		    "BEE2AA8C2A",
		    1);
	isc_md_test(md, ISC_MD_SHA224, TEST_INPUT("\x18\x80\x40\x05\xdd\x4f\xbd\x15\x56\x29"
					       "\x9d\x6f\x9d\x93\xdf\x62"),
		    "0xDF90D78AA78821C99B40BA4C966921ACCD8FFB1E98AC38"
		    "8E56191DB1",
		    1);
	isc_md_test(md, ISC_MD_SHA224, TEST_INPUT("\x55\xb2\x10\x07\x9c\x61\xb5\x3a\xdd\x52"
...
isc_md_sha256_test(void **state) {
	...
	isc_md_test(md, ISC_MD_SHA256, TEST_INPUT("abc"),
		    ...
		    "9CB410FF61F20015AD",
		    1);
	isc_md_test(md, ISC_MD_SHA256, TEST_INPUT("abcdbcdecdefdefgefghfghighijhijkijkljk"
						  "lmklmnlmnomnopnopq"),
	...
	isc_md_test(md, ISC_MD_SHA256, TEST_INPUT("01234567012345670123456701234567"),
	...
	isc_md_test(md, ISC_MD_SHA256, TEST_INPUT("\x19"),
		    ...
		    "D843709C0C9BC3E3D4",
		    1);
	isc_md_test(md, ISC_MD_SHA256, TEST_INPUT("\xe3\xd7\x25\x70\xdc\xdd\x78\x7c\xe3"
						  "\x88\x7a\xb2\xcd\x68\x46\x52"),
		    "0x175EE69B02BA9B58E2B0A5FD13819CEA573F3940A94F82"
		    "5128CF4209BEABB4E8",
		    1);
	isc_md_test(md, ISC_MD_SHA256, TEST_INPUT("\x83\x26\x75\x4e\x22\x77\x37\x2f\x4f\xc1"
...
isc_md_sha384_test(void **state) {
	...
	isc_md_test(md, ISC_MD_SHA384, TEST_INPUT("abc"),
		    ...
		    "A134C825A7",
		    1);
	isc_md_test(md, ISC_MD_SHA384, TEST_INPUT("abcdefghbcdefghicdefghijdefghijkefghijkl"
	...
	isc_md_test(md, ISC_MD_SHA384, TEST_INPUT("a"),
		    ...
		    "D87F3D8985",
		    1000000);
	isc_md_test(md, ISC_MD_SHA384, TEST_INPUT("01234567012345670123456701234567"),
	...
	isc_md_test(md, ISC_MD_SHA384, TEST_INPUT("\xb9"),
		    ...
		    "0AD1AB6938",
		    1);
	isc_md_test(md, ISC_MD_SHA384, TEST_INPUT("\xa4\x1c\x49\x77\x79\xc0\x37\x5f\xf1"
						  "\x0a\x7f\x4e\x08\x59\x17\x39"),
		    "0xC9A68443A005812256B8EC76B00516F0DBB74FAB26D665"
		    "913F194B6FFB0E91EA9967566B58109CBC675CC2"
		    "08E4C823F7",
		    1);
	isc_md_test(md, ISC_MD_SHA384, TEST_INPUT("\x39\x96\x69\xe2\x8f\x6b\x9c\x6d\xbc\xbb"
...
isc_md_sha512_test(void **state) {
	...
	isc_md_test(md, ISC_MD_SHA512, TEST_INPUT("abc"),
		    ...
		    1);
	isc_md_test(md, ISC_MD_SHA512, TEST_INPUT("abcdefghbcdefghicdefghijdefghijkefghijkl"
						  "fghijklmghijklmnhijklmnoijklmnopjklmnopq"
						  "klmnopqrlmnopqrsmnopqrstnopqrstu"),
	...
	isc_md_test(md, ISC_MD_SHA512, TEST_INPUT("a"),
		    ...
		    1000000);
	isc_md_test(md, ISC_MD_SHA512, TEST_INPUT("01234567012345670123456701234567"),
	...
	isc_md_test(md, ISC_MD_SHA512, TEST_INPUT("\xD0"),
		    ...
		    1);
	isc_md_test(md, ISC_MD_SHA512, TEST_INPUT("\x8d\x4e\x3c\x0e\x38\x89\x19\x14\x91\x81"
		    ...
		    1);
	isc_md_test(md, ISC_MD_SHA512, TEST_INPUT("\xa5\x5f\x20\xc4\x11\xaa\xd1\x32\x80\x7a"
...
int main(void) {
	...
	const struct CMUnitTest tests[] = {
		...
		cmocka_unit_test_setup_teardown(isc_md_update_test, _reset, _reset),
		cmocka_unit_test_setup_teardown(isc_md_final_test, _reset, _reset),
