...
ATF_TC_BODY(isc_sha1, tc)
{
	...
	hash_testcase_t testcases[] = {
		/* Test 1 */
		{TEST_INPUT("abc"),
		 "0xA9993E364706816ABA3E25717850C26C9CD0D89D", 1},
		/* Test 2 */
		{TEST_INPUT("abcdbcdecdefdefgefghfghighijhijkijk"
		            "ljklmklmnlmnomnopnopq"),
		 "0x84983E441C3BD26EBAAE4AA1F95129E5E54670F1", 1},
		/* Test 3 */
		{TEST_INPUT("a") /* times 1000000 */,
		 "0x34AA973CD4C4DAA4F61EEB2BDBAD27316534016F", 1000000},
		...
		/* Test 6 */
		{TEST_INPUT("\x5e"),
		 "0x5E6F80A34A9798CAFC6A5DB96CC57BA4C4DB59C2", 1},
#if 0
		...
		{TEST_INPUT("\x9a\x7d\xfd\xf1\xec\xea\xd0\x6e\xd6\x46"
		 ...
		 "0x82ABFF6605DBE1C17DEF12A394FA22A82B544A35", 1},
#if 0
		...
		{TEST_INPUT("\xf7\x8f\x92\x14\x1b\xcd\x17\x0a\xe8\x9b"
		            ...
		            "\xcd\xbb\xfb"),
		 "0xCB0082C8F197D260991BA6A460E76E202BAD27B3", 1},
		{NULL, 0, NULL, 1}
	};
...
ATF_TC_BODY(isc_md5, tc)
{
	 ...
	 */
	hash_testcase_t testcases[] = {
	        {TEST_INPUT(""), "0xD41D8CD98F00B204E9800998ECF8427E", 1},
	        {TEST_INPUT("a"), "0x0CC175B9C0F1B6A831C399E269772661", 1},
	        {TEST_INPUT("abc"), "0x900150983CD24FB0D6963F7D28E17F72", 1},
	        {TEST_INPUT("message digest"),
	         "0xF96B697D7CB7938D525A2F31AAF161D0", 1},
	        {TEST_INPUT("abcdefghijklmnopqrstuvwxyz"),
	         "0xC3FCD3D76192E4007DFB496CCA67E13B", 1},
	        {TEST_INPUT("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklm"
	                    "nopqrstuvwxyz0123456789"),
	         "0xD174AB98D277D9F5A5611C2C9F419D9F", 1},
	        {TEST_INPUT("123456789012345678901234567890123456789"
	                    "01234567890123456789012345678901234567890"),
	         "0x57EDF4A22BE3C955AC49DA2E2107B67A", 1},
	        {NULL, 0, NULL, 1}};
...
ATF_TC_BODY(isc_hmacsha1, tc)
{
	...
	hash_testcase_t testcases[] = {
		...
		{TEST_INPUT("\xDD\xDD\xDD\xDD\xDD\xDD\xDD\xDD\xDD\xDD"
		            ...
		            "\xDD\xDD\xDD\xDD\xDD\xDD\xDD\xDD\xDD\xDD"
		            "\xDD\xDD\xDD\xDD\xDD\xDD\xDD\xDD\xDD\xDD"),
		 "0x125D7342B9AC11CD91A39AF48AA17B4F63F175D3", 1},
		/* Test 4 */
		{TEST_INPUT("\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd"
		            ...
		            "\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd"
		            "\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd"),
		 "0x4C9007F4026250C6BC8414F9BF50C86C2D7235DA", 1},
#if 0
		/* Test 5 -- unimplemented optional functionality */
		{
		...
		{TEST_INPUT("Test Using Larger Than Block-Size Key and "
		 ...
		 "0xE8E99D0F45237D786D6BBAA7965C7808BBFF1A91", 1},
		{NULL, 0, NULL, 1}
	};
...
ATF_TC_BODY(isc_hmacmd5, tc)
{
	...
	hash_testcase_t testcases[] = {
		/* Test 1 */
		{TEST_INPUT("\x48\x69\x20\x54\x68\x65\x72\x65"),
		 "0x9294727A3638BB1C13F48EF8158BFC9D", 1},
		/* Test 2 */
		...
		{TEST_INPUT("\xDD\xDD\xDD\xDD\xDD\xDD\xDD\xDD\xDD\xDD"
		            ...
		            "\xDD\xDD\xDD\xDD\xDD\xDD\xDD\xDD\xDD\xDD"
		            "\xDD\xDD\xDD\xDD\xDD\xDD\xDD\xDD\xDD\xDD"),
		 "0x56BE34521D144C88DBB8C733F0E8B3F6", 1},
		/* Test 4 */
		{TEST_INPUT("\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd"
		            "\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd"
		            "\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd"
		            "\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd"
		            "\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd"),
		 "0x697EAF0ACA3A3AEA3A75164746FFAA79", 1},
#if 0
		/* Test 5 -- unimplemented optional functionality */
		{
			TEST_INPUT("Test With Truncation"),
...
ATF_TC_BODY(isc_crc64, tc)
{
	...
	hash_testcase_t testcases[] = {
	        {TEST_INPUT(""), "0x0000000000000000", 1},
	        {TEST_INPUT("a"), "0x9AA9C0AC27F473CE", 1},
	        {TEST_INPUT("abc"), "0x0297F4F93A818B04", 1},
	        {TEST_INPUT("message digest"), "0xF47B357AEAF97352", 1},
	        {TEST_INPUT("abcdefghijklmnopqrstuvwxyz"), "0xA1AA8B21F979F059",
	         1},
	        {TEST_INPUT("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklm"
	                    "nopqrstuvwxyz0123456789"),
...
ATF_TC_BODY(isc_hash_function, tc)
{
	...
	h2 = isc_hash_function("This is a long test", 20, ISC_TRUE, NULL);
...
ATF_TC_BODY(isc_hash_function_reverse, tc)
{
	...
	h2 = isc_hash_function_reverse("\007example\003org\000", 13, ISC_TRUE,
	                               NULL);
