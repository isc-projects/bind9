...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /dll /pdb:none /machine:I386 /out:"..\bin\Release\bindevt.dll" /implib:"$(OUTDIR)\bindevt.lib" 
LINK32_OBJS= \
	"$(INTDIR)\bindevt.obj" \
	"$(INTDIR)\bindevt.res"

"..\bin\Release\bindevt.dll" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
ALL : "..\bin\Debug\bindevt.dll" "$(OUTDIR)\bindevt.bsc"
...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /dll /pdb:none /debug /machine:I386 /out:"..\bin\Debug\bindevt.dll" /implib:"$(OUTDIR)\bindevt.lib" 
LINK32_OBJS= \
	"$(INTDIR)\bindevt.obj" \
	"$(INTDIR)\bindevt.res"

"..\bin\Debug\bindevt.dll" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
  $(LINK32_FLAGS) $(LINK32_OBJS)
<<
